...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:shoni_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;93mWarning: \033[1;92mNo Fight Just Keep Smiles' )
                jalan(' \033[1;91mWarning: \033[1;97mHappy Ramzan Mubraik' ) 
                jalan(' \033[1;91mWarning: \033[1;97mNamaz Zrori_5 Time 👆' )                
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;92mBlackMafia\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
def menu():
	...
	print "\033[1;91m-•◈•-\033[1;97m> \033[1;97m1.\x1b[1;93mStart Cloning India"
        ...
        print "\033[1;91m-•◈•-\033[1;97m> \033[1;97m6.\x1b[1;92mStart Simple Munda"
...
def pilih_crack():
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mBlackMafia\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed MR NOTY--•◈•---»" #Dev:Mr Noty
...
def pilih_hack():
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mBlackMafia\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By MR NOTY--•◈•---»" #Dev:Mr Noty
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (0 & Data Reset)↩\033[1;97m....'
	print"\033[1;91mTotal OK/\x1b[1;95mCP \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
	print """
 ╔══╗───█──────────█▀────╔══╗
